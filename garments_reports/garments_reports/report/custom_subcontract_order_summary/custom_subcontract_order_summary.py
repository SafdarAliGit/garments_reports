...
def get_data(report_filters):
	...
	for n, i in enumerate(data):
		data[n].update({"balance_qty": i['supplied_qty']-i['consumed_qty']})
	# calculate balance
	return data
...
def get_filters(report_filters):
	...
	for field in ["name", "company","master_towel_costing"]:
...
def get_columns(filters):
	return [
		...
		{"label": _("Balance"), "fieldname": "balance_qty", "fieldtype": "Float", "width": 150},
	]
